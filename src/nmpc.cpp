...
int main( ){
        ...
        ocp.subjectTo(f);
        ocp.subjectTo(AT_START,x==0.3);
        ocp.subjectTo(AT_START,y==1.2);
        ocp.subjectTo(AT_START,theta==0.4);
        ocp.subjectTo(AT_START,v==0.3);
        ocp.subjectTo(AT_START,omega==3.1);
	...
	std::cout << "Printam contols...\n";
        ...
        std::cout<<control(0,0)<<"  "<<control(1,0)<<"  "<<control(2,0)<<"\n";
        control.print();
      return 0;
}
